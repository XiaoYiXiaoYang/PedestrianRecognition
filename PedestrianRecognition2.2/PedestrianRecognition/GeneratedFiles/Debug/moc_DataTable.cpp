/****************************************************************************
** Meta object code from reading C++ file 'DataTable.h'
**
...
#error "The header file 'DataTable.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DataTable_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DataTable_t qt_meta_stringdata_DataTable = {
    {
QT_MOC_LITERAL(0, 0, 9) // "DataTable"
...
QT_INIT_METAOBJECT const QMetaObject DataTable::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_DataTable.data,
